def test_procedure(odrv0):
    ...
    odrv0.axis0.controller.config.input_filter_bandwidth = 3 # Decrease filter bandwidth to move to 10 deg up
    odrv0.axis1.controller.config.input_filter_bandwidth = 3 # Decrease filter bandwidth to move to 10 deg up
